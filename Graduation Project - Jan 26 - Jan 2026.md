# Graduation Project \- Jan 26 \- Jan 2026
...
1. **OpenStreetMap (Overpass API)** – Points of Interest  
2. **Wikivoyage / Wikipedia** – City guides and travel tips  
3. **Open-Meteo API** (optional, bonus) – Weather forecasts
